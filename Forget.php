...
<head>
   ...
   <!-- Library -->
	...
	<link rel="stylesheet" href="css/forget01.css">
    ...
    <section data-role="page" id="login">
      ...
      <div class="container">
		...
		<div class="login-form col-lg-12 col-md-12 col-sm-12">
		    <div class="titlemy title001 col-lg-12 col-md-12 col-sm-12">My Uni</div>
			<form>
				<input type="text" id="login-email" placeholder="Email"><br>

				<button type="button" class="login_button01">Submit</button>

			</form>
			 <div class="instruction">Please provide the username or email address that you used  when you signed up for my Uni.
				We will send you an email that will allow you to reset your password.</div>
			<div class="link">
			<div class="signin01"><a href="jq_mobile.php">Sign in</a></div>
			</div>
			</div>
